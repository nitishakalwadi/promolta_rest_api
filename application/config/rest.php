...
/*
|--------------------------------------------------------------------------
| REST Key Validity Column Name
|--------------------------------------------------------------------------
|
| Reat key validity column name
|
*/
$config['rest_key_validity_column'] = 'valid_till';
...
|--------------------------------------------------------------------------
|
| Reat key validity time
|
*/
$config['rest_key_validity'] = 60 * 60 * 24;
...
|
*/
$config['allow_any_cors_domain'] = TRUE;//nitish
